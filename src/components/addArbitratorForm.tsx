    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] ">
        <DialogHeader>
          ...
          <DialogDescription>Add a new Arbitrator</DialogDescription>
        </DialogHeader>
        <div className="">
          <div className="">
            ...
            <Input id="arbitratorname" defaultValue="" className="col-span-3" />
          </div>
          <div className="">
          ...
          <div className="">
            ...
            <Input id="customer" defaultValue="" className="col-span-3" />
          </div>
          <div className="">
