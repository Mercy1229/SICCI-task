    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] ">
        <DialogHeader>
          ...
          <DialogDescription>Add a new Hall</DialogDescription>
        </DialogHeader>
        <div className="">
          <div className="">
            ...
            <Input id="hallname" defaultValue="" className="col-span-3" />
          </div>
          <div className="">
          ...
          <div className="">
            ...
            <Input id="one hour" defaultValue="" className="col-span-3" />
          </div>
          <div className="halfday">
            <Label htmlFor="loanType" className="text-right font-normal">
              Half Day Price
            </Label>
            <Input id="halfday" defaultValue="" className="col-span-3" />
          </div>
          <div className="">
            <Label htmlFor="fullday" className="text-right font-normal">
              Full Day price
            </Label>
            <Input id="fullday" defaultValue="" className="col-span-3" />
          </div>
        </div>
        <DialogFooter>
          <Button
